...
/* $Id: SDL_net.h,v 1.18 2003/02/10 00:33:26 slouken Exp $ */
...
*/
extern int SDLNet_TCP_Send(TCPsocket sock, void *data, int len);
...
extern no_parse_void SDLNet_SetError(const char *fmt, ...);
extern no_parse_char * SDLNet_GetError(void);
*/
